// create server that listens for incoming requests
// using express
...
// tells Express to use our app.use() function for all routes
app.use(passwordProtected);

app.get("/", function(req, res){
    // find() -> used for Read (R-CRUD)
    ...
    <body>
      <div class="container">
        <h1 class="display-4 text-center py-1">Productivity App</h1>
        
        <div class="jumbotron p-3 shadow-sm">
          <form id="create-form" action="/create-item" method="POST">
            <div class="d-flex align-items-center">
              <input id="create-field" name="item" autofocus autocomplete="off" class="form-control mr-3" type="text" style="flex: 1;">
              <button class="btn btn-outline-secondary">Create Item</button>
            </div>
          </form>
        </div>
